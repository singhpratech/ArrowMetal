...
#include "lib_path.h" /* generated by ./configure: ARROWMETAL_DEFAULT_LIB */
...
/* The path ./configure found next to the package source at install time, or NULL. */
SEXP C_am_default_lib_path(void) {
  return ARROWMETAL_DEFAULT_LIB[0] == '\0' ? R_NilValue : Rf_mkString(ARROWMETAL_DEFAULT_LIB);
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"C_am_default_lib_path", (DL_FUNC)&C_am_default_lib_path, 0},

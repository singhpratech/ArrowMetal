...
| `test_ipc_views.py` | 9 | view types, big-endian integration files and `arrow.fixed_shape_tensor` through `scan_ipc` against pyarrow, the little-endian twins and the files' JSON |

...
| Go binding (`go/arrowmetal`) | 43 test functions, 132 cases with subtests | `arrow-go/v18`'s own `compute` where it has the function, plain Go loops where it does not ([GO.md](GO.md)) |
